...
<img src="https://github.com/claujs/weather_project_flutter/blob/main/.github/images/add_city_screen.png?raw=true" alt="Flutter Weather App Preview" width=25% height=25%>
